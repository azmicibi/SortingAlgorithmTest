...
//		cout << "\nSUCCESS:Array[" << n << "] Sorted with Bubble Sort in " << durations[0][k] << "seconds" << endl;
//		n *= 10;
//	}
//}
...
//	int temp,minimum;
//for (int k = 0; k < 3; k++) {
//	cout << "Array[" << n << "] Sorting in Progress with Selection Sort";
//		TimeStart = clock();
//	for (int i = 0; i<n - 1; i++)
//	{
//		minimum = i;
...
//	int j, temp;
//for (int k = 0; k < 3; k++) {
//	cout << "Array[" << n << "] Sorting in Progress with Insertion Sort";
//		TimeStart = clock();
//	for (int i = 0; i < n; i++) {
//		j = i;
...
//	while (flag) {
//		TimeEnd = clock();
//		cout<<"\rArray Sorting in Progress with Bubble Sort  "<<((double)(TimeEnd - TimeStart)) / CLOCKS_PER_SEC;
//	}
//}
//void Print() {
//	setfill(' ');
